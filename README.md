...
SNOWFLAKE_AUTHENTICATOR=externalbrowser  # optional (SSO)
SNOWFLAKE_PRIVATE_KEY_PATH=/path/to/key.p8  # optional (key-pair auth)
SNOWFLAKE_PRIVATE_KEY_PASSPHRASE=your_passphrase  # optional
SNOWFLAKE_QUERY_TAG=PLATTII_AI_ASSISTANT
SNOWFLAKE_STATEMENT_TIMEOUT_IN_SECONDS=1800
